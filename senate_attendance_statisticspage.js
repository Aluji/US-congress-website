...
var members = [];
//var polititians = {}; //OR WITHOUT IT polititians.D
fetch(url, {
  //mode: "no-cors",
...
<td>${getAllVotesR().toFixed(2)}</td>
<td></td>
      </tr>
      <tr> 
      <td>Democrats</td>
      <td>${GetNumofMembersD()}</td>
      <td>${getAllVotesD().toFixed(2)}</td>
      <td></td>
            </tr>
            ...
            <td>${getAllVotesI().toFixed(2)}</td>
            <td></td>
                  </tr>
                  <tr> 
                  <td>Total</td>
                  <td>${TotalNumMembers()}</td>
                  <td>${getAllVotesAverage().toFixed(2)}</td>
                  <td></td>
                        </tr>
